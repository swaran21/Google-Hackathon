...
const STATUS_COLORS = {
  pending: { color: "#facc15", bg: "rgba(250,204,21,0.12)", border: "rgba(250,204,21,0.25)", label: "Pending" },
  dispatched: { color: "#60a5fa", bg: "rgba(96,165,250,0.12)", border: "rgba(96,165,250,0.25)", label: "Dispatched" },
  en_route: { color: "#3b82f6", bg: "rgba(59,130,246,0.12)", border: "rgba(59,130,246,0.25)", label: "En Route" },
  at_scene: { color: "#a855f7", bg: "rgba(168,85,247,0.12)", border: "rgba(168,85,247,0.25)", label: "At Scene" },
...
export default function DriverBookingsPage() {
  ...
  const renderEmergencyCard = (em) => {
    ...
    return (
      <div key={em._id} className="glass-card" style={{ padding: "20px", borderRadius: "20px", display: "flex", flexDirection: "column", gap: "16px", transition: "transform 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.transform = "translateY(-2px)"} onMouseLeave={(e) => e.currentTarget.style.transform = "translateY(0)"}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "12px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
              <span style={{ padding: "4px 10px", borderRadius: "999px", fontSize: "0.7rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.1em", background: "var(--bg-glass)", border: "1px solid var(--border-glass)", color: "var(--text-muted)" }}>
                ID: {em._id.slice(-8)}
              </span>
            ...
            <h3 style={{ fontSize: "1.2rem", fontWeight: 800, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: "8px", margin: "4px 0" }}>
              ...
              <span style={{ background: "rgba(239,68,68,0.1)", color: "#ef4444", padding: "2px 8px", borderRadius: "6px", fontSize: "0.7rem", fontWeight: 900 }}>SEV {em.severity}</span>
            </h3>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px", background: "var(--bg-glass)", padding: "16px", borderRadius: "16px", border: "1px solid var(--border-glass)" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
            <div style={{ background: "rgba(59,130,246,0.1)", padding: "8px", borderRadius: "10px", color: "#3b82f6" }}><User size={18} /></div>
            <div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
            <div style={{ background: "rgba(34,197,94,0.1)", padding: "8px", borderRadius: "10px", color: "#22c55e" }}><Building2 size={18} /></div>
            <div>
        ...
        {["pending", "dispatched", "en_route", "at_scene"].includes(em.status) && (
          <div style={{ display: "flex", justifyContent: "flex-end", borderTop: "1px solid var(--border-glass)", paddingTop: "16px", marginTop: "4px" }}>
    ...
    <div className="page-enter" style={{ minHeight: "100vh", padding: "84px 20px 40px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "32px", display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ width: "64px", height: "64px", borderRadius: "20px", background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#3b82f6" }}>
            <Truck size={32} />
          </div>
          <div>
        ...
        {error ? (
          <div className="glass-card" style={{ padding: "20px", borderRadius: "16px", border: "1px solid rgba(239,68,68,0.3)", background: "rgba(239,68,68,0.05)", color: "#fca5a5", fontWeight: 600 }}>{error}</div>
        ) : emergencies.length === 0 ? (
          <div className="glass-card" style={{ padding: "60px 20px", textAlign: "center", borderRadius: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
            <div style={{ width: "64px", height: "64px", borderRadius: "50%", background: "var(--bg-glass)", border: "1px solid var(--border-glass)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-muted)" }}><Truck size={32} /></div>
